...
public class MainActivity extends AppCompatActivity {
    ...
    private void calculateFinalBill() {
        ...
        String szBillAmount = etBillAmount.getText().toString();
        if (!szBillAmount.equals("") && !szBillAmount.equals(".")){
            totalBillAmount = Float.valueOf(szBillAmount);
        } else {
            totalBillAmount = 0;
        }

        tipTotal = (percentage * totalBillAmount) / 100;
